...
{
    // Workout
    public static Workout ToModel(this WorkoutEntity entity)
    {
        return new Workout(entity.GainsAccountId, entity.Type, entity.Category,
            entity.Measurements.Select(m => m.ToModel()).ToList())
        {
            Id = entity.Id,
            PersonalBest = entity.PersonalBest?.ToModel(),
        };
    }

    public static WorkoutEntity ToEntity(this Workout model)
    {
        return new WorkoutEntity
        {
            ...
            PersonalBest = model.PersonalBest?.ToEntity(),
            Measurements = model.Measurements.Select(m => m.ToEntity()).ToList(),
        };
    }

    // Measurement
    public static Measurement ToModel(this MeasurementEntity entity)
    {
    ...
    public static MeasurementEntity ToEntity(this Measurement model)
    {
        return model switch
        {
