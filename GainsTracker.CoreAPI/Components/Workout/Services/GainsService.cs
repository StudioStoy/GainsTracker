...
public class GainsService : IGainsService
{
    ...
    public void AddWorkoutToGainsAccount(string username, WorkoutDto workoutDto)
    {
        ...
        Models.Workouts.Workout workout = new(gainsAccount.Id, workoutDto.WorkoutType, new List<Measurement>());
    ...
    {
        Models.Workouts.Workout workout = _bigBrain.GetWorkoutWithMeasurementsById(workoutId);
    ...
    public void AddMeasurementToWorkout(string workoutId, MeasurementDto dto)
    {
        ...
        Models.Workouts.Workout workout = _bigBrain.GetWorkoutById(workoutId);
